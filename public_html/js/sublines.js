        ...
        var buildSurveyBoxes = function() {
            self.getSurveys(function(surveyType) {
                surveyType = [{"_id":1, "json":{"id": 1,"name": "Lavadoras","idSurveyType": 3, "survey_type": [{"id": 3,"name": "Ventas","icon": "https://shop.miele.com.mx/811-home_default/lavadora-w1.jpg","color": "#7F7F7F"}]}},
                              {"_id":2, "json":{"id": 2,"name": "Secadoras","idSurveyType": 3, "survey_type": [{"id": 3,"name": "Ventas","icon": "https://shop.miele.com.mx/812-home_default/secadora-t1.jpg","color": "#7F7F7F"}]}},
                              {"_id":3, "json":{"id": 3,"name": "Máquinas de Planchar","idSurveyType": 3, "survey_type": [{"id": 3,"name": "Ventas","icon": "https://shop.miele.com.mx/825-home_default/fashionmaster.jpg","color": "#7F7F7F"}]}}];
